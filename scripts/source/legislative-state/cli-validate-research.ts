...
import { validateResearchEpisode } from "../../../src/source/legislative-state/research_validator.js";
import type { ResearchValidationEpisode } from "../../../src/source/legislative-state/types.js";

const RESEARCH_FIXTURES_DIR = path.resolve(
  process.cwd(),
  "data/source/legislative-state/fixtures/research_validation",
);
