...
export const COMPUTED_SURFACES: readonly ComputedSurface[] = [
  ...
  },
  {
    ...
    symbols: [
      ...
      "INSTITUTION_NOUNS",
      "institutionNoun",
      "projectOfficeholders",
      "atOrganization",
      "officeholderHeadline",
      "officeholderRecap",
      "projectPublicEvents",
      "toPublicationItem",
    ],
    ...
    grounding: [
      {
        ...
        description:
          "Recorded municipal government identity and readings, public-institution organization profiles, and active public-office work with its start date; public historical events that resolve as publication sources; already-written publications. Accepted civic offices without a named holder are exposed as unfilledOffices for producers and never narrated. Private and limited records are omitted.",
      },
      {
  ...
  },
  {
    ...
    symbols: [
      "noLifeYet",
      "projectLifeBiography",
      "groupBiographyByYear",
      "collectPassages",
      "identitySentence",
      "occupationFactSentence",
      "workSentence",
      "enrollmentSentence",
      "commitmentSentence",
      "publicPositionSentence",
      "educationFactSentence",
      "beliefSentence",
      "campaignCommitmentSentence",
    ],
    surface: "status",
    reachability: "PLAYER_REACHABLE",
    reachabilityReason:
    ...
    grounding: [
      {
        key: "recorded-life",
        description:
          "The person's identity, education and occupation facts, work expected/active/ended status with the relationship's start date, enrollment expected/active/completed status, life commitments, memories, choice-tagged events, attributed private beliefs, public positions with their statements, and campaign commitments with their statements, all actually on the save. Told in the second person. Unsupported emotion, cause, engine status reasons and proof-ledger wording are omitted.",
      },
    ],
  },
  {
