...
import { ALL_STATE_AUTHORITY_RECORDS } from "../../src/government_universe/authority_data.js";
import { normalizeGovernmentUniverse } from "../../src/government_universe/normalizer.js";
import { REPRESENTATIVE_GOVERNMENT_UNITS } from "../../src/government_universe/sample_corpus.js";

async function main(): Promise<void> {
  const rootDir = process.cwd();
  const corpusDir = join(rootDir, "data", "government_universe", "corpus");
  const sourcesDir = join(rootDir, "data", "government_universe", "sources");
