...
import { resampleLanczos } from "./office-plate-derive";
...
export const PG_BODY_SPECS: readonly PgBodySpec[] = [
  {
    ...
    suffix: "fl",
    masterFile: "bodies/PG_BODY_FEMALE_LEAN.png",
    masterSet: "Desktop body-geometry authority 'female lean.png'",
  },
  {
    familyId: "pg-male-lean",
    suffix: "ml",
    masterFile: "bodies/PG_BODY_MALE_LEAN.png",
...
export const PG_COMPONENT_SPECS: readonly PgComponentSpec[] = [
  head(
    ...
    "pg-head-f-01",
    "PG_HEAD_F_SAMPLE_01_BALD_NEUTRAL.png",
  ...
  head(
    ...
    "pg-head-m-001",
    "PG_FACE_M_001_BLACK_YOUNG_ADULT_BALD_NEUTRAL.png",
  ...
  head(
    ...
    "pg-head-m-002",
    "PG_FACE_M_002_WHITE_ADULT_BALD_NEUTRAL.png",
    "PG_MASCULINE_FACE_MASTERS_v1",
    "PG_FACE_M_002",
    ["pg-male-lean"],
  ),
  head(
    ...
    "pg-head-m-004",
    "PG_FACE_M_004_EAST_ASIAN_YOUNG_ADULT_BALD_NEUTRAL.png",
    "PG_MASCULINE_FACE_MASTERS_v1",
    "PG_FACE_M_004",
    ["pg-male-lean"],
  ),
  head(
    ...
    "pg-head-m-005",
    "PG_FACE_M_005_BLACK_OLDER_ADULT_BALD_NEUTRAL.png",
    "PG_MASCULINE_FACE_MASTERS_v1",
    "PG_FACE_M_005",
    ["pg-male-lean"],
  ),
  {
    ...hair(
      ...
      "pg-hair-f-black-001",
      "PG_HAIR_F_BLACK_001_SHORT_NATURAL_TAPERED_AFRO.png",
      "PG_HAIR_F_BLACK_001",
    ),
  ...
  hair(
    ...
    "pg-hair-f-black-002",
    "PG_HAIR_F_BLACK_002_ROUNDED_MEDIUM_AFRO.png",
    "PG_HAIR_F_BLACK_002",
  ),
  hair(
    "pg_hair_f_black_004_shoulder_natural_curls",
    "pg-hair-f-black-004",
    "PG_HAIR_F_BLACK_004_SHOULDER_LENGTH_NATURAL_CURLS.png",
    "PG_HAIR_F_BLACK_004",
  ),
  {
    ...hair(
      ...
      "pg-hair-f-black-005",
      "PG_HAIR_F_BLACK_005_HIGH_PUFF.png",
      "PG_HAIR_F_BLACK_005",
    ),
  ...
  hair(
    ...
    "pg-hair-f-black-007",
    "PG_HAIR_F_BLACK_007_SHOULDER_LENGTH_BOX_BRAIDS.png",
    "PG_HAIR_F_BLACK_007",
  ),
  hair(
    "pg_hair_f_black_008_long_box_braids",
    "pg-hair-f-black-008",
    "PG_HAIR_F_BLACK_008_LONG_BOX_BRAIDS.png",
    "PG_HAIR_F_BLACK_008",
  ),
  hair(
    "pg_hair_f_black_010_cornrows_low_bun",
    "pg-hair-f-black-010",
    "PG_HAIR_F_BLACK_010_CORNROWS_LOW_BUN.png",
    "PG_HAIR_F_BLACK_010",
  ),
  hair(
    "pg_hair_f_black_012_shoulder_locs",
    "pg-hair-f-black-012",
    "PG_HAIR_F_BLACK_012_SHOULDER_LENGTH_LOCS.png",
    "PG_HAIR_F_BLACK_012",
  ),
  top(
    "pg_top_001_short_sleeve_crew_tee",
    "pg-top-001",
    "PG_TOP_001_SHORT_SLEEVE_CREW_TEE.png",
    "PG_TOP_001",
  ),
  top(
    "pg_top_005_long_sleeve_button_shirt",
    "pg-top-005",
    "PG_TOP_005_LONG_SLEEVE_BUTTON_SHIRT.png",
    "PG_TOP_005",
  ),
  top(
    "pg_top_006_pullover_sweater",
    "pg-top-006",
    "PG_TOP_006_PULLOVER_SWEATER.png",
    "PG_TOP_006",
  ),
  top(
    "pg_top_011_structured_blazer",
    "pg-top-011",
    "PG_TOP_011_STRUCTURED_BLAZER.png",
    "PG_TOP_011",
  ),
  bottom(
    "pg_bottom_001_straight_leg_blue_jeans",
    "pg-bottom-001",
    "PG_BOTTOM_001_STRAIGHT_LEG_BLUE_JEANS.png",
    "PG_BOTTOM_001",
  ),
  bottom(
    "pg_bottom_005_dress_trousers",
    "pg-bottom-005",
    "PG_BOTTOM_005_DRESS_TROUSERS.png",
    "PG_BOTTOM_005",
  ),
  bottom(
    "pg_bottom_010_a_line_knee_skirt",
    "pg-bottom-010",
    "PG_BOTTOM_010_A_LINE_KNEE_LENGTH_SKIRT.png",
    "PG_BOTTOM_010",
  ),
  shoe(
    "pg_shoe_001_low_top_sneakers",
    "pg-shoe-001",
    "PG_SHOE_001_LOW_TOP_EVERYDAY_SNEAKERS.png",
    "PG_SHOE_001",
  ),
  shoe(
    "pg_shoe_004_leather_loafers",
    "pg-shoe-004",
    "PG_SHOE_004_LEATHER_LOAFERS.png",
    "PG_SHOE_004",
  ),
  shoe(
    "pg_shoe_009_low_practical_flats",
    "pg-shoe-009",
    "PG_SHOE_009_LOW_PRACTICAL_FLATS.png",
    "PG_SHOE_009",
  ),
];
