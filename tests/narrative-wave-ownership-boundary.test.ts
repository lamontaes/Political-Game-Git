 ...
 * This branch is PR #83 — the declarative content bank — and an open head
 * failed it the moment its merge with `main` was measured: the carve-out list
 * below hands `content-bank`, `content-browser`, `content-registry` and
 * `content-export` to PR #83, so an open head flagged this branch for building
 * exactly the surfaces it is the owner of. It surfaced on the synthetic merge
 * into `main`, which is the first place this file and this branch's files
 * coexist.
 *
 ...
 * packet knows nothing about — including this branch's own content bank.
 */
