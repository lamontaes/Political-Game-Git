...
test("P2R1 preserves and reloads the old age-32 calibrated fixture when its next beat is quiet", async ({
  ...
  // Same setup and first-option chooser as the unchanged failing legacy
  // persistence proof. Keep its lost-scene evidence; add proof of the actual
  // quiet-state save/reload path instead of changing its seed or assertions.
  await page.goto("/");
