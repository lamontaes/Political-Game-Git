...
for (const [generation, width, height, age, seed] of [
  ...
  [10, 1200, 720, 34, "ef481a28a3fa3d3045bff245a29a8eeff"],
  [10, 1280, 860, 6, "talk-pair"],
  [10, 1200, 720, 6, "talk-pair"],
] as const) {
  test(`A41 age ${age} generation ${generation}: actual room Talk and saved appearance at ${width}x${height}`, async ({
    page,
  }, info) => {
...
const privateInputsReady = privateModularInputs("a41-pose-composed.spec.ts", [
