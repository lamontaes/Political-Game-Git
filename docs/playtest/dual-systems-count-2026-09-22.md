...
**Walked the same day** (`dual-systems-walk-2026-09-22.md`, on `main` at
`4965f63c`). Both rows are now player findings. A Colorado governor was offered
four program subjects in a year, none of them infrastructure, while a Kentucky
legislator's drafting table opened on transit, bridges, broadband and water
lines. In Augusta, Atlanta and Phoenix, a candidate is told there is nothing to
stand for below governor, and the state's compiled municipal election law does
not appear.
