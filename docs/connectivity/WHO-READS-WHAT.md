...
Generated 2026-09-23T01:19:18.144Z from 130dd113 (links modified). 13 producers, 26 missing links: 10 open, nobody has taken it, 3 being built in an open pull request, 6 handed to its owner, 7 waiting on research, 0 closed.
...
5. **People learning what a bill is about, so they can form a view on it.** From an enacted law (producer owned by Legislation). open, nobody has taken it.
...
`a-scandal-about-somebody` · counted at main at 130dd113, measured 2026-09-23 · producer owned by Consequences for corruption
...
1. **A complaint about anyone who is not the player** (Consequences for corruption; handed to its owner). openMatter accepts any subject, but no producer ever names an NPC. ChatGPT answered: broaden the actors and incidents on the existing weekly route; no quota. (question: `what-opens-a-scandal-about-somebody-else`; handed off: 2026-09-23, brief sent to Consequences for corruption)

### A disaster

`a-disaster` · counted at main at 130dd113, measured 2026-09-23 · producer owned by How the world changes
...
`a-new-party` · counted at main at 130dd113, measured 2026-09-23 · producer owned by People and life
...
`what-a-person-believes` · counted at main at 130dd113, measured 2026-09-23 · producer owned by People and life
...
`an-act-of-violence` · counted at main at 130dd113, measured 2026-09-23 · producer owned by How the world changes
...
`an-enacted-law` · counted at main at 130dd113, measured 2026-09-23 · producer owned by Legislation
...
2. **People learning what a bill is about, so they can form a view on it** (People and life; open, nobody has taken it). Four callers of introduceMeasure attach propositionIds (legislation-docket.ts:963, legislation-world.ts:451, legislation-bundle-docket.ts:356, legislative-clock.ts:730). The only reader is the integrity check at legislation-integrity.ts:156. recordPropositionExposure has no caller outside demo.ts, so a bill never exposes anybody to its question. (hook: `src/simulation/politics.ts#recordPropositionExposure`)
3. **A law changing a rule of government, such as a term limit or a filing requirement** (Legislation; open, nobody has taken it). The readers are finished (candidacy.ts:363, executive-term-limits.ts:175). The producers are not reached: fileRuleChangeProvision has no caller, and the constitutional workspace only creates proposal-threshold changes (ConstitutionalWorkspace.tsx:91-95). (hook: `src/simulation/enacted-rule-changes.ts#fileRuleChangeProvision`)
4. **An income tax in the other 51 places** (Nationwide government; open, nobody has taken it). Collection needs a tax power for the jurisdiction, and the generated file carries only US-AK with no script that writes it. (hook: `src/fiscal-authority/tax-powers.generated.json`)

### An ethics finding

`an-ethics-finding` · counted at main at 130dd113, measured 2026-09-23 · producer owned by Consequences for corruption
...
`an-international-crisis` · counted at main at 130dd113, measured 2026-09-23 · producer owned by How the world changes
...
1. **A player facing a finding choosing how to answer, or resigning** (Consequences for corruption; handed to its owner). The screen and the writer are both built; the answer surface needs a place in the office panel. (handed off: 2026-09-23, brief sent to Consequences for corruption)

### Bills with several subjects, and delegated bill steps

`multi-subject-bills` · counted at main at 130dd113, measured 2026-09-23 · producer owned by Legislation
...
`a-move` · counted at main at 130dd113, measured 2026-09-23 · producer owned by Migration and big social movements
...
`local-election-rules` · counted at main at 130dd113, measured 2026-09-23 · producer owned by Every town in America
...
`a-couple-forming` · counted at main at 130dd113, measured 2026-09-23 · producer owned by Relationships
...
1. **Two people who grow close becoming a couple, including a one-night stand** (Relationships; being built in an open pull request). The owner answered on 2026-09-23: both, all the way, and one-night stands exist. (in flight: the Relationships thread is building it)
2. **Real census households for a new character's family** (People and life; handed to its owner). selectAcsPumsHouseholdDonor and applyAcsPumsCharacterHistoryBridge (1,628 lines) have no caller; the family odds at the opening are made up instead. (handed off: 2026-09-23, brief sent to People and life)
