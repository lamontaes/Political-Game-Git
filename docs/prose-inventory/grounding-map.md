...
| `life/adult` | 382 | 360 | 0 | colleague-identity, household-kinship, persistent-cast |
...
464 templates across 43 distinct
...
- **adult.local-issue-position** — A posted meeting does not establish an agenda item the player has read or an opinion they hold about it. The issue and acquired knowledge are missing.
...
- **adult.household-quiet-evening** — A shared household does not establish a free evening, the other person being present, or their willingness to spend it together.
- **adult.work-extra-hours** — A work relationship does not establish a request for extra hours. The request and its terms are missing.
- **adult.candidacy-approach** — Age and group participation do not establish an approach about running for office. The actual approach and role are missing.
...
- **adult.weekend-invitation** — An always-true gate establishes no Saturday event, invitation or absence of obligations. The actual invitation and its time are missing.
...
- **adult.friend-in-difficulty** — Prior interaction does not establish a disclosure, a difficulty or exclusive player knowledge. The disclosure and its scope are missing.
- **adult.friend-favour** — Prior interaction does not establish a favour request, its terms or its importance to the other person. The actual request is missing.
