...
- **3189** inventoried templates.
- Reachability: 372 CURRENTLY_UNREACHABLE, 110 DEV_FIXTURE_ONLY, 90 LEGACY_OR_WITHDRAWN, 2190 PLAYER_REACHABLE, 69 UNKNOWN, 358 WITHHELD_BY_GROUNDING.
...
- 3189 rendered items for 3189 inventory records;
