...
- **2039** inventoried templates.
- Reachability: 91 DEV_FIXTURE_ONLY, 90 LEGACY_OR_WITHDRAWN, 1489 PLAYER_REACHABLE, 369 WITHHELD_BY_GROUNDING.
- **3460** coverage candidates still need a
...
- 2039 rendered items for 2039 inventory records;
