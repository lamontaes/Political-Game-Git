...
- **3016** inventoried templates.
- Reachability: 339 CURRENTLY_UNREACHABLE, 110 DEV_FIXTURE_ONLY, 90 LEGACY_OR_WITHDRAWN, 2050 PLAYER_REACHABLE, 69 UNKNOWN, 358 WITHHELD_BY_GROUNDING.
- **8138** coverage candidates still need a
...
- 3016 rendered items for 3016 inventory records;
