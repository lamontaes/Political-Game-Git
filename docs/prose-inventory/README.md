...
- **3235** inventoried templates.
- Reachability: 394 CURRENTLY_UNREACHABLE, 110 DEV_FIXTURE_ONLY, 90 LEGACY_OR_WITHDRAWN, 2214 PLAYER_REACHABLE, 69 UNKNOWN, 358 WITHHELD_BY_GROUNDING.
- **8715** coverage candidates still need a
...
- 3235 rendered items for 3235 inventory records;
