...
- **2645** inventoried templates.
- Reachability: 42 CURRENTLY_UNREACHABLE, 106 DEV_FIXTURE_ONLY, 90 LEGACY_OR_WITHDRAWN, 1981 PLAYER_REACHABLE, 68 UNKNOWN, 358 WITHHELD_BY_GROUNDING.
- **6637** coverage candidates still need a
...
- 2645 rendered items for 2645 inventory records;
