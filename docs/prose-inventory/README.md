...
- **2453** inventoried templates.
- Reachability: 42 CURRENTLY_UNREACHABLE, 91 DEV_FIXTURE_ONLY, 90 LEGACY_OR_WITHDRAWN, 1793 PLAYER_REACHABLE, 68 UNKNOWN, 369 WITHHELD_BY_GROUNDING.
- **5886** coverage candidates still need a
...
- 2453 rendered items for 2453 inventory records;
