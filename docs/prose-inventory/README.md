...
- **2486** inventoried templates.
- Reachability: 42 CURRENTLY_UNREACHABLE, 106 DEV_FIXTURE_ONLY, 90 LEGACY_OR_WITHDRAWN, 1811 PLAYER_REACHABLE, 68 UNKNOWN, 369 WITHHELD_BY_GROUNDING.
- **6169** coverage candidates still need a
...
- 2486 rendered items for 2486 inventory records;
