...
- **3186** inventoried templates.
- Reachability: 369 CURRENTLY_UNREACHABLE, 110 DEV_FIXTURE_ONLY, 90 LEGACY_OR_WITHDRAWN, 2190 PLAYER_REACHABLE, 69 UNKNOWN, 358 WITHHELD_BY_GROUNDING.
- **8660** coverage candidates still need a
...
- 3186 rendered items for 3186 inventory records;
