...
- **2683** inventoried templates.
- Reachability: 42 CURRENTLY_UNREACHABLE, 106 DEV_FIXTURE_ONLY, 90 LEGACY_OR_WITHDRAWN, 2019 PLAYER_REACHABLE, 68 UNKNOWN, 358 WITHHELD_BY_GROUNDING.
- **6612** coverage candidates still need a
...
- 2683 rendered items for 2683 inventory records;
