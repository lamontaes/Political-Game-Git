...
- **2944** inventoried templates.
- Reachability: 332 CURRENTLY_UNREACHABLE, 110 DEV_FIXTURE_ONLY, 90 LEGACY_OR_WITHDRAWN, 1985 PLAYER_REACHABLE, 69 UNKNOWN, 358 WITHHELD_BY_GROUNDING.
- **7551** coverage candidates still need a
...
- 2944 rendered items for 2944 inventory records;
