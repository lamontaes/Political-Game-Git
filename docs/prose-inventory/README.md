...
- **2106** inventoried templates.
- Reachability: 91 DEV_FIXTURE_ONLY, 90 LEGACY_OR_WITHDRAWN, 1466 PLAYER_REACHABLE, 68 UNKNOWN, 391 WITHHELD_BY_GROUNDING.
- **5722** coverage candidates still need a
...
- 2106 rendered items for 2106 inventory records;
