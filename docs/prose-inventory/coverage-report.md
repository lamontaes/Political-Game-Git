...
| --- | --- |
| INVENTORIED | 2772 |
| INTENTIONALLY_NON_PLAYER_FACING | 6406 |
| DIAGNOSTIC_OR_TEST | 6018 |
| **NEEDS_CLASSIFICATION** | **7573** |

Scanned 825 files holding 88341 string
...
| 29 | `src/presentation/world39-news.ts` |
