...
| --- | --- |
| INVENTORIED | 2950 |
| INTENTIONALLY_NON_PLAYER_FACING | 6874 |
| DIAGNOSTIC_OR_TEST | 6986 |
| **NEEDS_CLASSIFICATION** | **9438** |

Scanned 1055 files holding 104836 string
...
| Candidates | File |
| --- | --- |
| 425 | `src/presentation/contextual-scene-families.ts` |
