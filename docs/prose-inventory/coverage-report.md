...
| --- | --- |
| INVENTORIED | 2512 |
| INTENTIONALLY_NON_PLAYER_FACING | 5901 |
| DIAGNOSTIC_OR_TEST | 5290 |
| **NEEDS_CLASSIFICATION** | **6567** |

Scanned 648 files holding 77646 string
...
| 4 | `src/presentation/office-onboarding.ts` |
