...
| --- | --- |
| INVENTORIED | 2107 |
| INTENTIONALLY_NON_PLAYER_FACING | 5526 |
| DIAGNOSTIC_OR_TEST | 4450 |
| **NEEDS_CLASSIFICATION** | **5777** |

Scanned 478 files holding 66755 string
...
| 126 | `src/simulation/civil-personnel-actions.ts` |
