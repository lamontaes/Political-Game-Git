...
| --- | --- |
| INVENTORIED | 2295 |
| INTENTIONALLY_NON_PLAYER_FACING | 5488 |
| DIAGNOSTIC_OR_TEST | 4434 |
| **NEEDS_CLASSIFICATION** | **5766** |

Scanned 488 files holding 67078 string
