...
| DIAGNOSTIC_OR_TEST | 4676 |
| **NEEDS_CLASSIFICATION** | **6162** |

Scanned 552 files holding 71254 string
...
| 118 | `src/simulation/opening-life-content.ts` |
...
| 23 | `src/simulation/life-content-reconciliation.ts` |
