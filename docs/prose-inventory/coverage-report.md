...
| DIAGNOSTIC_OR_TEST | 8104 |
| **NEEDS_CLASSIFICATION** | **10745** |

Scanned 1246 files holding 117632 string
...
| 152 | `src/player/PlayerGame.tsx` |
| 128 | `src/simulation/legislation.ts` |
| 124 | `src/presentation/guide-terms.ts` |
...
| 52 | `src/simulation/people-contact.ts` |
...
| 22 | `src/simulation/office-qualification-rules.ts` |
...
| 17 | `src/player/WorldOrientationPanel.tsx` |
