...
| --- | --- |
| INVENTORIED | 2946 |
| INTENTIONALLY_NON_PLAYER_FACING | 6543 |
| DIAGNOSTIC_OR_TEST | 6430 |
| **NEEDS_CLASSIFICATION** | **8416** |

Scanned 912 files holding 94377 string
...
| 12 | `src/presentation/shell-navigation.ts` |
