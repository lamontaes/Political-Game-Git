...
| --- | --- |
| INVENTORIED | 1910 |
| INTENTIONALLY_NON_PLAYER_FACING | 4623 |
| DIAGNOSTIC_OR_TEST | 3431 |
| **NEEDS_CLASSIFICATION** | **2953** |

Scanned 320 files holding 49364 string
...
| 5 | `src/presentation/conversation-subjects.ts` |
