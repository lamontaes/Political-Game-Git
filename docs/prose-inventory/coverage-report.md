...
| --- | --- |
| INVENTORIED | 3139 |
| INTENTIONALLY_NON_PLAYER_FACING | 7321 |
| DIAGNOSTIC_OR_TEST | 8205 |
| **NEEDS_CLASSIFICATION** | **10846** |

Scanned 1205 files holding 116323 string
...
| 151 | `src/simulation/policy-pack-us-state-and-local.ts` |
