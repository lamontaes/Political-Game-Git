...
The named-presence test likewise retains the explicit uncalibrated refusal control. Refresh the framing JSON/Markdown through the existing capture command after scene authoring; ordinary tests still check the committed report read-only.
