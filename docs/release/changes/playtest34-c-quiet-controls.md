---
id: playtest34-c-quiet-controls
impact: patch
section: Improved
title: Quiet rest, honest talk, and a calendar that does not invent travel
---

New Game drops you into the room instead of an idle activity card. Talk is the
in-person conversation in that room, with faces and no clock movement per line.
