---
id: chatgpt-answered-twenty-two
impact: none
---

Twenty-two open research questions are now answered and five more extended,
from ChatGPT's stress-test batch of 2026-09-22 15:58Z. The queue went from
thirty-nine open to seventeen.

Each answer carries its answer key and the section it came from, and the
gates ChatGPT attached are kept in `stillOpen` rather than dropped — including
the thirteen subjects the batch explicitly parks, among them exact personality
bands, trait prevalence and school naming.
