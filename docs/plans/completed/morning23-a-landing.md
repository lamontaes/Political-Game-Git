...
Completed 2026-09-12 from `origin/main` at
`cc83c628707be429839c53c536181ceb65647735` in the isolated
`codex/morning23-a-landing` worktree.

## Landed scope

- Kept the merged Fable player shell as the root/UI authority.
- Added the current-main macOS launcher, the sourced hometown population read,
