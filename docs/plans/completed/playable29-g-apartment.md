...
This records the first canonical-03 increment atdd4a0117. ExactH905px was subsequently resolved to ordinary-02 and completed in playable29-g-905-room.md; the updated PR contains both normal-choice variants, not a claim that the first variant alone closed H1.
