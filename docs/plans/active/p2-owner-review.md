...
- Source/test commit: `c0c1757a285143c3b1ee09f47f6d00602a93a26b`; the enclosing evidence commit adds reports and regenerated corpus only.
- Rejected/start and pre-publication PR head: `dd9ac1f79a301d71c128a03aab6bac555f21fc0c`.
- Accepted main integrated normally: `1b0603ca61f454ad2e8b9412b4869ae6d38e2b6f`, including accepted PR124. No rebase or force push.
...
- Compatibility/identity/grounding focused group: **142/142 pass**. Probes **21/21**, Skill/agent hygiene **43 files clean**. Format, lint and typecheck pass. Corpus check passes with **1,880 templates, 257 warnings and 2,846 unclassified candidates**; no hard errors. Scanner counts are measured at **48,873 literals, 1,910 inventoried, 320 files**.
- Final complete unit suite: **3,091 pass, 11 fail, 2 existing skips / 3,104 total**. Full `npm run validate` stopped at these test failures; its remaining commands were run separately. No breadth assertions, skips or timeouts were relaxed.
