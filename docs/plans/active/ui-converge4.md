...
Existing exclusive UI owner: codex/ui-core-release-transfer, PR144.
Start checkpoint34003c506e5f8fc3dc6dc04f5b405c26619aa0f8, fresh main6b95f371.
Current authority: FINISH-WAVE4 shared execution contract and sectionC, read in
full. Preserve31browser proofs, recorded independent donor proof and original
staff/anchor corrections. Hosted34309039100 repository validation passed then
browsers were canceled; neither full acceptance nor a new runtime defect.

Work: apply frozen MUNI/ECON/OPENING/LAND and corrected NEWS/LIFE/EXEC/DEV
interfaces; implement saved private Journal notes/intentions and practical
organization without World mutation; expose cumulative canonical release notes;
consume current PEOPLE/ENV adapters; preserve #130 cold decode and repair URL
identity retention; prove complete normal navigation and title/room transitions.

Root/corpus ownership remains here. Feature owners retain domain writers. A
bounded read-only raster helper supplies diagnosis/patch artifacts, not acceptance
or a second root. Existing ENV server remains untouched. Full/browser slots are
