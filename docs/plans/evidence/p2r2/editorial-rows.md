...
| `work-credit` `let-it-go:memory`                   | You chose not to correct the claim about whose work it was.                                            | You let the claim about whose work it was stand.                                          | The negative frame again. "Let it stand" is also more accurate: not correcting something in a workplace is an act with an effect.                                                                                                                                                         |
