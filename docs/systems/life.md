...
World schema 12, generator `demo-world-v12`, and snapshot format 11 serialize the complete Stage 5 graph together with Stage 6 metric/observation/causal/effect/policy/due histories, generated provenance, bounded context people, exact money, and typed life sources through deterministic JSON and the Node-only SQLite repository. Person materializer version 4 and Stage 5 life semantics remain unchanged. Unsupported older versions remain rejected until a migration chain exists.
