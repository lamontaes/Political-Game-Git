...
Stage 6 Run B aggregate evaluation is explicit and writes no automatic daily/monthly/quarterly tick. Stage 6 Run C may schedule one typed delayed policy realization through the existing due-item mechanism. It resolves once through normal policy writers and the ordinary terminal due lifecycle; it adds no recurrence, parallel clock, or opaque recurrence expression.
