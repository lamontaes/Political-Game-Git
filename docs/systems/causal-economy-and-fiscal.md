...
The causal catalog plus causal/effect, policy, and incident histories are JSON-safe. World schema 13, generator `demo-world-v13`, metric catalog `world-metric-catalog-v2`, causal catalog `causal-mechanism-catalog-v1`, incident catalog `incident-catalog-v1`, and snapshot format 12 persist through deterministic JSON and the Node-only SQLite repository; person materializer remains version 4. Integrity rejects malformed catalogs/keys/curves, missing or target-incompatible magnitude bases, malformed interval bases, duplicate identity, dangling or forward sources/parents, cycles, unavailable historical references, mismatched metrics/units/currencies, invalid timing/threshold/bounds, derived-state writes, unsafe exact arithmetic, noncontiguous global history, and incident effects whose root/source/plan linkage is not exact.
