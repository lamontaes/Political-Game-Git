...
The current foundation implements bounded formative/adult situation consequences, explicit meaningful relationship moments, and evidence-backed resource pressure, but not autonomous personality development, autonomous memory recall, automatic relationship upkeep/decay, autonomous finance/housing behavior, generalized event causality, institutions and mutable law, elections, campaigns, legislation, public-opinion populations, dialogue, or a polished player UI. Situations may append an appraisal or return a non-applying repeated-history development proposal; they do not silently create tendencies, values, goals, or beliefs. Later systems may consume this architecture without redefining its separation, provenance, determinism, history, or player-autonomy contracts.
