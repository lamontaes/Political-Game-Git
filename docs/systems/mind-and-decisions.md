...
World schema 11 and snapshot format 10 preserve the mind catalog, control state, all Stage 4 history families, complete Stage 5 life/resource/housing records, Stage 6 metric/observation/causal/effect/due histories, generated provenance, typed life-history source references, and the complete decision trace through deterministic JSON and Node-only SQLite round trips. Unsupported older versions remain rejected until migrations exist.
