...
Run B introduces a bounded life-situation resolver, and Run C adds meaningful relationship moments plus explicit personal resource-pressure consequences; neither is a generalized event engine. They commit through ordinary `HistoricalEvent` and existing consequence writers. They have no reusable prerequisite graph, causal chain language, autonomous world/economic shock scheduler, or parallel event store; those remain Stage 6 work.
