...
Acquired through `source:acquire -- --domain education`: NCES CCD2024–25 preliminary directory bundle (May14 release, August2025 bundle), HD2024, IC2024 including `ic2024_rv.csv` updated September2026, and both IPEDS dictionaries. A follow-up acquired HD2025/IC2025 and their dictionaries after the official product page established the newly available2025–26 provisional edition needed by normal2026-01-05 starts. Exact URLs, real retrieval instants, archive byte hashes and sizes are in `data/source/education/artifact-lock.json`. The CCD bundle contains its school/LEA dictionaries and release notes. No person-level data is used.

All 101,333 school rows,19,484 LEA rows and6,072 HD rows are retained. Every5,963 IC2024 row joins by UNITID. A further5,985 HD2025 observations and every IC2025 row are retained separately, totaling132,874 institution-edition observations. Stable institution IDs survive editions; counts of observations are not counts of unique institutions. No arbitrary school ceiling; paging limits display only. CCD LEAID/NCESSCH retain zero padding; FIPST is state, never county. CCD county remains unknown. HD COUNTYCD is the publisher's five-digit county code, independently tested for UK21067 and Harvard25017. No city-name join to a World jurisdiction is fabricated.
...
Institution listing and reported award/grade/noncredit capability are informational. Founding dates remain null. Admission, exact major, academic prerequisites, historic attendance, individual acceptance probability, financial aid and exact official tuition are not inferred. Source-year applicability is confined to2024-07-01 through2025-06-30 for2024–25 and2025-07-01 through2026-06-30 for2025–26; this is a bounded source-year consumer, not a claim those are every institution's term dates. A2026-01-05 normal save can use2025–26 reported capabilities; it cannot create a2024–25-source offer. Dates outside both edition windows remain informational. Persisted accepted study continues according to save-world terms after source-year end.

Supported noncredit categories NONCRDT1–8 can create explicitly game-authored offers: one study period of about49 elapsed days and $200 tuition due at period end for new enrollments (WEEKEND19-F). Legacy saves with per-session accepted terms keep session scheduling until their recorded progress is consumed. These are design terms, not empirical duration/cost or official school policy. A request creates an application event plus a private offer artifact from the represented issuer. Accept/decline is explicit; offers expire after their issue date. Open-admission statistics never decide individual admission. Degree/grade rows remain browseable with the dependent missing-program/admission fields stated.
...
Diagnostic `edu-path7-proof.html` proves feature pointer/keyboard selection and save when run; it never counts as normal-player reachability. UI reports the first checkpoint locally mounted; actual normal journey awaits the current-edition follow-up and proof. No human visual acceptance is claimed.
