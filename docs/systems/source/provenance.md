...
This contract sits in `src/source/provenance.ts` and is deliberately isolated from simulation state (`src/simulation/`) and player UI (`src/player/`, `src/presentation/`).
