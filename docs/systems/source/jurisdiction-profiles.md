...
## Schema Architecture (`src/source/governance/types.ts`)
...
## Validator (`src/source/governance/validator.ts`)
...
## Synthetic Fixtures (`src/source/governance/__fixtures__/synthetic-profiles.ts`)
