...
Stage 6 Run A world-metric scopes and optional future due-item jurisdictions reuse the same stable open jurisdiction IDs. A metric definition may legitimately have no state or observation for a jurisdiction, and no coverage is fabricated. Run A adds no government institution, authority, office, budget, rule, territory-specific series, or hard-coded state hierarchy; later effective law and sourced civic/statistical content remain separate dependencies.
