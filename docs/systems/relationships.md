...
Development proposals may identify a relationship direction, but they do not append an interaction or apply a relationship change. Run A child authority is only a structural effective-dated relationship; detailed custody powers, litigation, visitation, and jurisdiction-specific law remain Stage 7 concerns. Full asymmetric trust and obligation histories, autonomous relationship maintenance and decisions, resource transfers, third-party effects, and automatic knowledge propagation remain future systems. See [Core Life](life.md).
