...
Runs A through D deliberately contain no automatic economy tick, mortality/incapacity/evidence system, law/institutions/elections, automatic forecast generator, media ecology, territory-specific content, or player-facing UI. Forecast, canonical metric state, observations, causal attribution, realization, incident truth, and subjective knowledge remain distinct. Future due items remain the only future-transition mechanism and contain no opaque payload or recurrence language. See D-042 through D-045, the completed Run A–D plans, [World State, Observations, and Future Transitions](systems/world-state-and-observations.md), [Causal Mechanisms, Lightweight Economy, and Fiscal Continuity](systems/causal-economy-and-fiscal.md), [Quantitative Policy Semantics, Baselines, and Implementation](systems/quantitative-policy.md), and [Generalized Incidents and Follow-Ons](systems/incidents.md). Run E remains future; Stage 6 remains **IN PROGRESS**.
