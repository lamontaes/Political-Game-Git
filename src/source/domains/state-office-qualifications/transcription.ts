...
export const QUALIFICATION_TRANSCRIPTIONS: readonly ReviewedTranscription[] = [
  ...
  },
  {
    ...
    excerpt:
      "No person shall be a member of the Senate who shall not have attained the age of thirty years",
  },
  {
    batch: "31C",
    stateUsps: "NJ",
    ...
    artifactId: "nj-constitution-art-4-sec-1",
    locator: "N.J. Const. art. IV, § I, ¶ 2",
    excerpt: "have been a citizen and resident of the State for four years",
  },
  {
    batch: "31C",
    stateUsps: "NJ",
    ...
    locator: "N.J. Const. art. IV, § I, ¶ 2",
    excerpt:
      "No person shall be a member of the General Assembly who shall not have attained the age of twenty-one years",
  },
  {
    batch: "31C",
    stateUsps: "NJ",
    ...
    artifactId: "nj-constitution-art-4-sec-1",
    locator: "N.J. Const. art. IV, § I, ¶ 2",
    excerpt: "have been a citizen and resident of the State for two years",
  },
  {
    batch: "31C",
    stateUsps: "MA",
  ...
  },
  {
    ...
    excerpt:
      "who shall have been an inhabitant of this Commonwealth five years at least immediately preceding his election",
  },
  {
    batch: "31D",
    stateUsps: "OH",
