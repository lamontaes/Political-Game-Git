 ...
 * declarations is shaped by who asked, when, and under what program rules, as
 ...
 *
 * A derivation, and labeled one: OpenFEMA publishes no area-type field, and
...
export interface FemaDeclarationRecord {
   ...
   * the first on eight real records. They are different programs and they
