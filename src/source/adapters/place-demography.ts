...
import type { EconomicContextReadModel } from "./economic-context";
...
function knownNumber(
  value: EconomicContextReadModel["observations"][number]["value"],
): number | "unknown" {
...
function geographyMatchesPlace(
  place: LifePlace,
  observation: EconomicContextReadModel["observations"][number],
): boolean {
...
function latestMatchingBeaPopulation(
  place: LifePlace,
  economic: EconomicContextReadModel,
):
  | { readonly status: "missing" }
  | {
      readonly status: "ineligible";
      readonly sample: EconomicContextReadModel["observations"][number];
  ...
  | {
      ...
      readonly observation: EconomicContextReadModel["observations"][number];
      readonly people: number;
    } {
...
export function readPlaceDemography(
  place: LifePlace,
  economic?: EconomicContextReadModel | null,
