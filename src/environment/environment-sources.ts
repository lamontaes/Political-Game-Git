...
export const ENVIRONMENT_SOURCES: readonly EnvironmentSourceRecord[] = [
  ...
  {
    sourceId: "env_playtest65_civic_generic_r3",
    label: "Civic building — revision 3",
    path: "art/generated/candidates/art-desk/playtest65/environment/civic-generic-r3.png",
    disposition: "candidate-preview-only",
    sceneId: null,
    remainingStep:
      "Review the composed local-government panel before public release.",
    owedBy: "the owner",
    openRequestIds: [],
    note: "Exact owner-approved Art Desk revision 3. `OPENING_INFORMATION_PLATES.locality` in `playtest65-visual-layout.ts` composes it behind the local-government information slot in the isolated private preview. Generic civic architecture only, never a named landmark; the manifest remains unreleased and native detail is unverified.",
  },
  {
    sourceId: "env_playtest65_pikeville_valley_street_434644_r1",
    label: "Pikeville valley street — opening candidate",
    path: "art/generated/candidates/art-desk/playtest65/regional/pikeville-valley-street-firefly-434644-r1.png",
    disposition: "candidate-preview-only",
    sceneId: null,
    remainingStep:
      "Owner review of the opening regional plate before it leaves candidate preview.",
    owedBy: "the owner",
    openRequestIds: [],
    note: "Owner-uploaded candidate, banked in `BANKED_OPENING_REGIONAL_CANDIDATES` against Pikeville place 2160852 for May to September only. Eligibility is a geographic rule, not a claim about the saved home; the manifest remains unreleased and the executed model is unverified.",
  },
  {
    sourceId: "env_playtest65_wooded_valley_town_street_cleanup_r2",
    label: "Appalachian coal-region town street — revision 2",
    path: "art/generated/candidates/art-desk/playtest65/regional/wooded-valley-street-cleanup-r2.png",
    disposition: "candidate-preview-only",
    sceneId: null,
    remainingStep:
      "Owner review, and a decision on the unresolved 1950x1300 two-times target.",
    owedBy: "the owner",
    openRequestIds: [],
    note: "Private review candidate in `REGIONAL_TYPE_REVIEW_CANDIDATES`, eligible for the appalachian-coal-region-town region type from May to September. A declared edited derivative; the encoded 1536x1024 covers the current 975x650 display and is not enlarged to reach it.",
  },
  {
    sourceId: "env_playtest65_great_plains_pond_r1",
    label: "Great Plains pond — regional candidate",
    path: "art/generated/candidates/art-desk/playtest65/regional/great-plains-pond-r1.png",
    disposition: "candidate-preview-only",
    sceneId: null,
    remainingStep:
      "Owner review of the regional backdrop before it leaves candidate preview.",
    owedBy: "the owner",
    openRequestIds: [],
    note: "Private review candidate in `REGIONAL_TYPE_REVIEW_CANDIDATES`, eligible for the great-plains-grassland region type from May to September. Regional context behind the state information cards, never statewide uniform coverage; the manifest remains unreleased.",
  },
  /* --- In ordinary play ------------------------------------------------- */
  {
  ...
  },
  {
    ...
    label: "The retired community meeting hall master",
    path: "art/references/masters/scene-environment/PG_TITLE_BG_COMMUNITY_MEETING_HERO_SLOT_02_5504x3072.png",
    disposition: "reference-only",
    sceneId: null,
    remainingStep: null,
    owedBy: null,
    openRequestIds: [],
    note: "FRONTDOOR44 permanently retired the baked-audience plate from title, creator, questionnaire, gameplay, fallbacks and rotation. The original master remains reference-only history; it grants no runtime or regeneration path.",
  },
  {
  ...
  },
  {
    ...
    label: "The retired community meeting hall title framing",
    path: "art/references/masters/scene-environment/PG_TITLE_BG_COMMUNITY_MEETING_HERO_SLOT_02_5504x3072.png",
    disposition: "reference-only",
    sceneId: null,
    remainingStep: null,
    owedBy: null,
    openRequestIds: [],
    note: "Historical title framing only. FRONTDOOR44 removed its runtime scene, registry entry, fallback and rotation admission; no private pack may restore it.",
  },
