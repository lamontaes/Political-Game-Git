...
import type { EntityId, PersonAppearance } from "../simulation/types";
import {
  appearanceAgeState,
  ...
  it.skipIf(needsRepair)(
    ...
    () => {
      ...
      const sibling = appearanceForNewPerson(
        ...
        "person-adult-sibling" as EntityId,
      ...
      const child = appearanceForNewPerson(
        ...
        "person-young-child" as EntityId,
