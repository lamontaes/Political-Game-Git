import { privateModularInputs } from "./private-test-inputs";
...
const available = privateModularInputs("modular-source-kit", [
  directory + "registry-candidate.json",
  directory + "calibration.json",
  directory + "fit-report.json",
]);
...
describe.skipIf(!available)(
  ...
  () => {
    ...
    it.skipIf(
      !privateModularInputs("modular-source-kit expansion", [
        directory + "expansion-registry.json",
        directory + "expansion-calibration.json",
        directory + "expansion-fit-report.json",
      ]),
    )(
    ...
    it.skipIf(
      !privateModularInputs("modular-source-kit poses", [
        directory + "pose-pack.json",
      ]),
    )(
