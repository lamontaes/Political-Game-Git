...
function assertOpeningLifecycleAtAge(startAge: number) {
  ...
  // President, Vice President, Chief Justice, and the home state's governor,
  // whose opening term is now dated by the office calendar.
