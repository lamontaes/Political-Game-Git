...
export const SCENE_CONSUMERS: readonly SceneConsumerDeclaration[] = [
  ...
  },
  {
    ...
    sceneId: null,
    wiredThrough: null,
    openRequestIds: ["env-legislative-chamber-floor"],
    blockedSeam: null,
    note: "No chamber master exists in any approved bank. The workspace stays a document surface; no room is substituted for the one that has not been made.",
  },
  {
