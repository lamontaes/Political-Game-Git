export interface CivicGlossaryAuthoring {
...
export interface CivicGlossaryEntry {
  ...
  /**
   * Research notes for whoever writes or revises an entry. Never rendered in
   * play: a citation in the middle of an interview is an author's note, not
   * something the character or the player is looking at.
   */
  readonly authoring: CivicGlossaryAuthoring;
}
