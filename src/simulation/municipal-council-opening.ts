...
export function ensureMunicipalCouncilOpening(
  ...
  next = recordWorldEvent(next, {
    ...
    summary: `${reading.bodyName ?? reading.displayName} begins this fictional world with ${size} generated councilors, using its compiled seat count; their identities and numbered labels are game facts.`,
    context: {
      location: null,
      socialContext: null,
      pressure: null,
