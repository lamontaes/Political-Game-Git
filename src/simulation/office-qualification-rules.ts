          ...
          reason:
            held !== null
              ...
              : row.field === "DISTRICT_RESIDENCE" &&
                ...
                ? `${row.citation} ${required === null ? "sets a residence requirement" : `requires ${required.label} of residence`} for the district. This character's town lies across more than one district, so the game cannot say which one they live in, and it will not pick one to answer for them.`
