 ...
 *
 * Four families whose clause shapes were read from the pilot's infrastructure
 * record: transit, bridges, broadband and water. They are the tranche that
 * proved a family could produce a materially different bill, and they are kept
 * here unchanged in meaning while the instrument banks beside them prove the
 * same for kinds of act rather than kinds of subject.
 */
