...
CHARACTER: You are at least seventeen years old and hold a paid job.
RELATIONSHIPS: {role:colleague} works with you; the world records the working relationship. Write their name as the literal token {role:colleague}; it is substituted at composition. Use no other name for them.
KNOWN WORLD FACTS:

- The world holds an active work relationship for you.
- Some months ago you took {role:colleague}'s shift when they asked you to.
- You now need a shift covered.
- {role:colleague} is on the rota that day.
  PLAYER KNOWLEDGE: the rota and your own need.
  CHARACTER KNOWLEDGE: you remember taking their shift. Nothing establishes whether {role:colleague} remembers it, or considers themselves to owe you anything.
  ESTABLISHED TRAITS: none.
  EARLIER CHOICES: you took {role:colleague}'s shift when they asked.
  ...
  Additionally: do not state or imply that {role:colleague} owes you, feels obliged, will agree, or will refuse. Do not say why you need the shift covered.
  PURPOSE: Whether to spend a favour, and whether to name it as one. Asymmetric memory is the point: what you did may not have registered.
